...
1. In the [{{site.data.keyword.Bluemix_notm}} console](https://{DomainName}) locate the {{site.data.keyword.cloudaccesstrailshort}} instance **secure-file-storage-activity-tracker** and open its dashboard.
