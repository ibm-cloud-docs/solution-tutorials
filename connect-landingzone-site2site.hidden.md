...
![Architecture diagram of site-to-site-VPN connection with strongSwan](diagrams/connect-landingzone-site2site.hidden.drawio){: caption="Figure 1. Connect a VPC landing zone deployable architecture to a network with a site-to-site VPN and strongSwan" caption-side="bottom"}
