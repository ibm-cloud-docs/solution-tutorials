...
9. Do you need to deploy a cluster on [Virtual Private Cloud infrastructure](https://cloud.ibm.com/docs/containers?topic=containers-plan_clusters#vpc_basics), VPC gives you the security of a private cloud environment with the dynamic scalability of a public cloud. Or [Classic infrastructure](https://cloud.ibm.com/docs/containers?topic=containers-plan_clusters#plan_basics).
