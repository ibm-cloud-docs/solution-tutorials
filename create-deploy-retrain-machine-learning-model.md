...
6. For `ML_INSTANCE_ID`, run the below command in the Cloud Shell by passing the name of the machine learning service key. **_You will use the ML service credentials later in the tutorial_**
   ```sh
...
5. Click **{{site.data.keyword.pm_short}} providers**
