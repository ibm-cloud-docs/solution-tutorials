...
1. Access the {{site.data.keyword.Bluemix_notm}} catalog and create an instance of [{{site.data.keyword.cloudaccesstrailshort}}](https://{DomainName}/catalog/services/activity-tracker). Note that there can only be one instance of {{site.data.keyword.cloudaccesstrailshort}} per Cloud Foundry space.
...
3. To view all activity tracker events, ensure you have permissions assigned:
   1. Go to [Identity & Access > Users](https://{DomainName}/iam/#/users).
