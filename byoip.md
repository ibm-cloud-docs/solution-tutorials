...
[{{site.data.keyword.Bluemix_notm}} Virtual Private Cloud (VPC)](../infrastructure/vpc/) supports BYOIP for fully virtual environments on the {{site.data.keyword.Bluemix_notm}}. It is an alternative to the secure private network enclosure described in [this tutorial](./secure-network-enclosure.html).
