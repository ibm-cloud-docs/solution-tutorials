...
5. Select the frontend VSI **vpc-pubpriv-frontend-vsi**, scroll to **Network Interfaces** and click **Reserve** under **Floating IP** to associate a public IP address to your frontend VSI. Save the associated IP Address to a clipboard for future reference.
...
1.  First, add the following **inbound** rules using **Add rule**. They allow incoming HTTP requests and Ping (ICMP).
    ...
    <tbody>
       ...
       <tr>
          ...
          <td>This optional rule allows the frontend server to be pinged by any host.</td>
       </tr>
    </tbody>
    </table>

1.  Next, add this **outbound** rule.
